...
- `migrations/0001_users_auth.sql` (create) — the four tables.
...
**Files:**
- Create: `migrations/0001_users_auth.sql`
...
```
Expected: `0001_users_auth.sql` shows as applied; four tables exist.

- [ ] **Step 3: Commit**

```bash
git add migrations/0001_users_auth.sql
